...
export const panels = {
  ...
  files: {
    ...
    text: 'Gerenciador leve para projetos, notas e links, sem depender do armazenamento fraco do tablet.',
  ...
  fallback: {
    icon: Shield,
    title: 'Módulo seguro',
    text: 'Esse módulo ainda não tem painel próprio. O sistema abriu uma tela segura no lugar.',
